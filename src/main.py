...
class secBootMain(MCX_main.secBootMcxMain):
    ...
    def callbackBootDeviceConfiguration( self, event ):
        ...
        if self.bootDevice == RTyyyy_uidef.kBootDevice_FlexspiNor or \
           ...
           self.bootDevice == RTxxx_uidef.kBootDevice_XspiNor:
            ...
            if self.bootDevice == RTxxx_uidef.kBootDevice_FlexcommSpiNor or \
               self.bootDevice == RTxxx_uidef.kBootDevice_LpFlexcommSpiNor:
            ...
            recoverySpiNorFrame.setNecessaryInfo(self.mcuSeries, self.mcuDevice)
    ...
    def callbackShowRevisionHistory( self, event ):
        msgText = ((uilang.kMsgLanguageContentDict['revisionHistory_v1_0_0'][self.languageIndex]) +
                   ...
                   (uilang.kMsgLanguageContentDict['revisionHistory_v6_4_0'][self.languageIndex]) +
                   (uilang.kMsgLanguageContentDict['revisionHistory_v6_5_0'][self.languageIndex]) +
                   (uilang.kMsgLanguageContentDict['revisionHistory_v6_5_1'][self.languageIndex]))
...
if __name__ == '__main__':
    ...
    g_main_win.SetTitle(u"NXP MCU Boot Utility v6.5.1")
    g_main_win.Show()
